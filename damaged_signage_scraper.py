"""
damaged_signage_scraper.py
Category-targeted image scraper with three-layer filtering.

Category: damaged_signage / infrastructure
...
Run:
  python damaged_signage_scraper.py
"""
...
MODIFIERS = {
    "en": [
        "damaged road sign", "broken traffic sign", "vandalized street sign",
        "faded road sign", "missing road sign", "broken traffic light",
        "damaged street infrastructure", "broken street light",
        "crumbling road signage",
    ],
    "fr": [
        "panneau routier endommagé", "panneau de signalisation abîmé",
        "feu de circulation cassé", "signalisation routière dégradée",
        "panneau vandalisé", "infrastructure routière dégradée",
        "lampadaire cassé",
    ],
    "pt": [
        "placa de trânsito danificada", "sinalização danificada",
        "semáforo quebrado", "placa de rua vandalisada",
        "infraestrutura urbana danificada",
    ],
}

GENERIC_EXTRAS = [
    # English generic
    "damaged road sign Africa",
    "broken traffic sign Africa",
    "vandalized street sign Africa",
    "faded road sign Africa",
    "broken traffic light Africa",
    "missing road sign Africa",
    "damaged street light Africa",
    "broken infrastructure Africa urban",
    "crumbling signage Africa",
    "bent road sign Africa",
    "graffiti road sign Africa",
    "illegible street sign Africa",
    "rusted road sign Africa",
    "damaged signage urban Africa",
    "broken signage sub-saharan Africa",
    # Social media
    "damaged road sign site:reddit.com",
    "broken traffic sign site:flickr.com",
    "vandalized street sign site:twitter.com",
    "panneau routier endommagé site:twitter.com",
    # City-specific
    "damaged road sign Lagos",
    "broken traffic light Nairobi",
    "missing road sign Accra",
    "vandalized sign Kampala",
    "damaged signage Douala",
    "broken street light Kinshasa",
    "faded road sign Johannesburg",
    "damaged traffic sign Dar es Salaam",
]
...
# ============================================================
# CLIP PROMPTS — tuned for damaged signage / infrastructure
# ============================================================

KEEP_PROMPTS = [
    "a photograph of a damaged or broken road sign on a street",
    "a photograph of a vandalized traffic sign with graffiti or dents",
    "a photograph of a faded and illegible street sign",
    "a photograph of a bent or knocked-over road sign",
    "a photograph of a broken traffic light on a pole",
    "a photograph of a missing or stolen road sign stump",
    "a photograph of rusted and deteriorated road signage",
    "a photograph of damaged urban street infrastructure in Africa",
    "a photograph of a crumbling or broken street sign post",
    "a photograph of a shattered or cracked road sign panel",
]

REJECT_PROMPTS = [
    "a portrait photograph of a person",
    "a photograph of a politician giving a speech",
    "a photograph of a new undamaged road sign being installed",
    "a photograph of a clean well-maintained traffic sign",
    ...
    "a photograph of road construction or workers",
    "a photograph of a pothole or damaged road surface",
    "a photograph of garbage or waste on a street",
    "a photograph of a bright colourful billboard advertisement",
...
AFRICA_PROMPTS = [
    ...
    "an urban street in tropical Africa with worn infrastructure",
]
NON_AFRICA_PROMPTS = [
...
SUSPICIOUS_IMG_TOKENS = [
    ...
    "billboard", "advertisement", "advert",
...
ALT_STRONG = [
    # EN
    "damaged sign", "broken sign", "vandalized sign", "faded sign",
    "missing sign", "road sign", "street sign", "traffic sign",
    "broken traffic light", "damaged signage", "bent sign",
    "rusted sign", "illegible sign", "crumbling sign",
    # FR
    "panneau endommagé", "panneau abîmé", "panneau cassé",
    "signalisation dégradée", "panneau vandalisé", "feu cassé",
    # PT
    "placa danificada", "sinalização danificada", "semáforo quebrado",
]

ALT_ARTICLE_ONLY = [
    "budget", "billion", "parliament", "government", "minister",
    "announce", "speech", "statement", "report", "policy",
    "road safety campaign", "new signage programme",
]
...
OUT_DIR    = Path(__file__).parent / "data" / "raw" / "damaged_signage_scraped"
...
def main():
    ...
    print(f"  2. Spot-check {REJECT_DIR} — real signs missed? lower MIN_KEEP_SCORE.")
    print(f"  3. Move verified keeps → data/processed/train/damaged_signage/")
